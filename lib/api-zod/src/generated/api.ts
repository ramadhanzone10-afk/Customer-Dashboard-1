...
export const GetWorkspaceResponse = zod.object({
  ...
  "relationshipType": zod.string().describe('One of \'sales\', \'clients\', \'investors\', \'candidates\', \'personal\', \'custom\''),
  "entityLabel": zod.string().describe('Singular label for a contact (e.g. \'Lead\', \'Client\')'),
  "entityLabelPlural": zod.string(),
  "affiliationLabel": zod.string().describe('Label used for company\/affiliation field'),
