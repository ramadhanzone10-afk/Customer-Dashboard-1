 ...
 */
export const updateWorkspace = async (workspaceUpdate: WorkspaceUpdate, options?: RequestInit): Promise<Workspace> => {
 ...
 */
export const initializeWorkspace = async (workspaceInit: WorkspaceInit, options?: RequestInit): Promise<Workspace> => {
...
export const getInitializeWorkspaceMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof initializeWorkspace>>, TError,{data: BodyType<WorkspaceInit>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof initializeWorkspace>>, TError,{data: BodyType<WorkspaceInit>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof initializeWorkspace>>, {data: BodyType<WorkspaceInit>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type InitializeWorkspaceMutationResult = NonNullable<Awaited<ReturnType<typeof initializeWorkspace>>>
 ...
 * @summary Complete first-run setup (choose relationship type + stage names)
 */
export const useInitializeWorkspace = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof initializeWorkspace>>, TError,{data: BodyType<WorkspaceInit>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const createStage = async (newStage: NewStage, options?: RequestInit): Promise<Stage> => {
...
export const getCreateStageMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createStage>>, TError,{data: BodyType<NewStage>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createStage>>, TError,{data: BodyType<NewStage>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createStage>>, {data: BodyType<NewStage>}> = (props) => {
          const {data} = props ?? {};
 ...
 */
export const reorderStages = async (stageReorder: StageReorder, options?: RequestInit): Promise<Stage[]> => {
...
export const getReorderStagesMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof reorderStages>>, TError,{data: BodyType<StageReorder>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof reorderStages>>, TError,{data: BodyType<StageReorder>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof reorderStages>>, {data: BodyType<StageReorder>}> = (props) => {
          const {data} = props ?? {};
...
export const createContact = async (newContact: NewContact, options?: RequestInit): Promise<Contact> => {
...
export const getCreateContactMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createContact>>, TError,{data: BodyType<NewContact>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createContact>>, TError,{data: BodyType<NewContact>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createContact>>, {data: BodyType<NewContact>}> = (props) => {
          const {data} = props ?? {};
...
export const listInteractions = async (id: string, options?: RequestInit): Promise<Interaction[]> => {
...
export const getListInteractionsQueryOptions = <TData = Awaited<ReturnType<typeof listInteractions>>, TError = ErrorType<unknown>>(id: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listInteractions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListInteractionsQueryKey(id);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listInteractions>>> = ({ signal }) => listInteractions(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listInteractions>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useListInteractions<TData = Awaited<ReturnType<typeof listInteractions>>, TError = ErrorType<unknown>>(
 id: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listInteractions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const createInteraction = async (id: string,
    newInteraction: NewInteraction, options?: RequestInit): Promise<Interaction> => {
...
export const getCreateInteractionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createInteraction>>, TError,{id: string;data: BodyType<NewInteraction>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createInteraction>>, TError,{id: string;data: BodyType<NewInteraction>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createInteraction>>, {id: string;data: BodyType<NewInteraction>}> = (props) => {
          const {id,data} = props ?? {};
 ...
 */
export const recentActivity = async (params?: RecentActivityParams, options?: RequestInit): Promise<ActivityItem[]> => {
...
export const getRecentActivityQueryOptions = <TData = Awaited<ReturnType<typeof recentActivity>>, TError = ErrorType<unknown>>(params?: RecentActivityParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof recentActivity>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getRecentActivityQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof recentActivity>>> = ({ signal }) => recentActivity(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof recentActivity>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useRecentActivity<TData = Awaited<ReturnType<typeof recentActivity>>, TError = ErrorType<unknown>>(
 params?: RecentActivityParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof recentActivity>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
